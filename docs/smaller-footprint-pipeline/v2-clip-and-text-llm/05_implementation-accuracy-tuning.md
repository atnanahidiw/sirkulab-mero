...
```bash
uv run --python .venv-export/bin/python scripts/debug_vision.py --image lizard.jpg --compare-templates
uv run --python .venv-export/bin/python scripts/debug_vision.py --image lizard.jpg --attrs visual_group,color --topk 8
uv run --python .venv-export/bin/python scripts/debug_vision.py --image lizard.jpg --probe "a lizard|a sea slug|a reptile with scales"
```
...
```bash
uv run --python .venv-export/bin/python scripts/eval_vision.py            # ~340 deduped images, ~6 min CPU
```
