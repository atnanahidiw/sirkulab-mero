...
USAGE
-----
  uv run --python .venv-export/bin/python scripts/eval_vision.py            # full run (~5-10 min CPU)
...
APP_REPO = HERE.parents[2]                       # sirkulab-mero
WORKDIR = HERE.parents[3]                         # common parent
