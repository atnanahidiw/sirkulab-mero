...
Outputs:
  - `<data-repo>/data/processed/vision_eval_combined_visual_siglip2_b16.jsonl`
  - `<data-repo>/data/processed/README_combined_vision_siglip2_b16.md`
  - `<data-repo>/data/processed/summary_combined_vision_siglip2_b16.json`

USAGE
-----
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/eval_combined_vision_siglip2_b16.py
...
from export_vision_model_siglip2_b16 import DISPLAY_NAME, HF_MODEL, INPUT_SIZE, SUFFIX, load_siglip2_b16
