#!/usr/bin/env python3
"""Validate the MobileCLIP2-S2 comparison vision assets.

Companion to `scripts/smaller-footprint-pipeline-v2/comparison/export_vision_model_mobileclip2_s2.py`.
...
USAGE
-----
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/validate_vision_model_mobileclip2_s2.py
  #   --models-dir assets/models   --hf-model MobileCLIP2-S2
...
import numpy as np
from export_vision_model_mobileclip2_s2 import DISPLAY_NAME, HF_MODEL, SUFFIX, load_mobileclip2_s2
...
def main() -> int:
    ...
    if checks.failures:
        print("\nMissing assets — run scripts/smaller-footprint-pipeline-v2/comparison/export_vision_model_mobileclip2_s2.py first.")
        return 1
