#!/usr/bin/env python3
"""Validate the SigLIP 2 B/16 comparison vision assets.

Companion to `scripts/smaller-footprint-pipeline-v2/comparison/export_vision_model_siglip2_b16.py`.
...
USAGE
-----
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/validate_vision_model_siglip2_b16.py
  #   --models-dir assets/models   --hf-model ViT-B-16-SigLIP2
...
import numpy as np
from export_vision_model_siglip2_b16 import DISPLAY_NAME, HF_MODEL, SUFFIX, load_siglip2_b16
...
def main() -> int:
    ...
    if checks.failures:
        print("\nMissing assets — run scripts/smaller-footprint-pipeline-v2/comparison/export_vision_model_siglip2_b16.py first.")
        return 1
