...
Outputs:
  - `<data-repo>/data/processed/vision_eval_combined_visual_mobileclip2_s2.jsonl`
  - `<data-repo>/data/processed/README_combined_vision_mobileclip2_s2.md`
  - `<data-repo>/data/processed/summary_combined_vision_mobileclip2_s2.json`

USAGE
-----
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/eval_combined_vision_mobileclip2_s2.py
...
from export_vision_model_mobileclip2_s2 import DISPLAY_NAME, HF_MODEL, INPUT_SIZE, SUFFIX, load_mobileclip2_s2
