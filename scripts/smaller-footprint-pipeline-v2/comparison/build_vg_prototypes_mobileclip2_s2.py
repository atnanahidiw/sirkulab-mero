...
Output:
  assets/models/visual_group_prototypes_mobileclip2_s2.pb
...
USAGE
-----
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/build_vg_prototypes_mobileclip2_s2.py
...
from export_vision_model_mobileclip2_s2 import DISPLAY_NAME, HF_MODEL, SUFFIX, INPUT_SIZE, load_mobileclip2_s2
