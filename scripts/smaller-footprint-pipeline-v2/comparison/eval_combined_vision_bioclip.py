...
Outputs:
  - `<data-repo>/data/processed/vision_eval_combined_visual_bioclip.jsonl`
  - `<data-repo>/data/processed/README_combined_vision_bioclip.md`
  - `<data-repo>/data/processed/summary_combined_vision_bioclip.json`

USAGE
-----
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/eval_combined_vision_bioclip.py
