...
Output:
  assets/models/visual_group_prototypes_bioclip.pb
...
USAGE
-----
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/build_vg_prototypes_bioclip.py
...
from export_vision_model_bioclip import DISPLAY_NAME, HF_MODEL, SUFFIX, INPUT_SIZE, load_bioclip
