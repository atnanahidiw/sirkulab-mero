...
USAGE
-----
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/export_vision_model_bioclip2.py   # downloads HF weights itself
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/validate_vision_model_bioclip2.py # validate the produced assets
