...
Output:
  assets/models/visual_group_prototypes_siglip2_b16.pb
...
USAGE
-----
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/build_vg_prototypes_siglip2_b16.py
...
from export_vision_model_siglip2_b16 import DISPLAY_NAME, HF_MODEL, SUFFIX, INPUT_SIZE, load_siglip2_b16
