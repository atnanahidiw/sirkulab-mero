...
Builds one BioCLIP 2 centroid prototype per species from the labeled images in the
...
USAGE
-----
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/eval_species_retrieval_bioclip2.py
