#!/usr/bin/env python3
"""Evaluate SigLIP 2 (ViT-B/16) zero-shot `visual_group` accuracy across prompt templates.
...
Outputs:
  - per-image JSONL → `<data-repo>/data/processed/vision_eval_visual_group_siglip2_b16.jsonl`
  - a note          → `<data-repo>/data/processed/README_vision_visual_group_siglip2_b16.md`
  - per-template accuracy printed to stdout.

USAGE
-----
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/eval_vision_siglip2_b16.py
...
from export_vision_model_siglip2_b16 import DISPLAY_NAME, HF_MODEL, SUFFIX, INPUT_SIZE, load_siglip2_b16  # noqa: E402
