...
Outputs:
  - `<data-repo>/data/processed/vision_eval_combined_visual_bioclip25_vith14.jsonl`
  - `<data-repo>/data/processed/README_combined_vision_bioclip25_vith14.md`
  - `<data-repo>/data/processed/summary_combined_vision_bioclip25_vith14.json`

USAGE
-----
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/eval_combined_vision_bioclip25_vith14.py
...
from export_vision_model_bioclip25_vith14 import DISPLAY_NAME, HF_MODEL, INPUT_SIZE, SUFFIX, load_bioclip25_vith14
