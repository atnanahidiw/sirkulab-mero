#!/usr/bin/env python3
"""Validate the BioCLIP 2 comparison vision assets.

Companion to `scripts/smaller-footprint-pipeline-v2/comparison/export_vision_model_bioclip2.py`.
...
USAGE
-----
  uv run --python .venv-export/bin/python scripts/smaller-footprint-pipeline-v2/comparison/validate_vision_model_bioclip2.py
  #   --models-dir assets/models   --hf-model hf-hub:imageomics/bioclip-2
...
import numpy as np
from export_vision_model_bioclip2 import DISPLAY_NAME, HF_MODEL, SUFFIX, load_bioclip2
...
def main() -> int:
    ...
    if checks.failures:
        print("\nMissing assets — run scripts/smaller-footprint-pipeline-v2/comparison/export_vision_model_bioclip2.py first.")
        return 1
