...
USAGE
-----
  python scripts/smaller-footprint-pipeline/comparison/export_vision_model_siglip2_b16.py   # downloads weights itself
  python scripts/smaller-footprint-pipeline/comparison/validate_vision_model_siglip2_b16.py # validate the produced assets
