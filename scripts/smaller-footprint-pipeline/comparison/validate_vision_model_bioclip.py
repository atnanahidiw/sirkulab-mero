...
Companion to `scripts/smaller-footprint-pipeline/comparison/export_vision_model_bioclip.py`.
...
USAGE
-----
  .venv-export/bin/python scripts/smaller-footprint-pipeline/comparison/validate_vision_model_bioclip.py
...
def main() -> int:
    ...
    if checks.failures:
        print("\nMissing assets — run scripts/smaller-footprint-pipeline/comparison/export_vision_model_bioclip.py first.")
        return 1
