...
USAGE
-----
  python scripts/smaller-footprint-pipeline/comparison/export_vision_model_mobileclip2_s2.py   # downloads weights itself
  python scripts/smaller-footprint-pipeline/comparison/validate_vision_model_mobileclip2_s2.py # validate the produced assets
