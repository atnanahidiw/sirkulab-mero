...
USAGE
-----
  python scripts/smaller-footprint-pipeline/comparison/export_vision_model_bioclip25_vith14.py   # downloads HF weights itself
  python scripts/smaller-footprint-pipeline/comparison/validate_vision_model_bioclip25_vith14.py # validate the produced assets
